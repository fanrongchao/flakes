...
def main():
    ...
    p.add_argument(
        "--rules",
        default=os.path.expanduser("~/.local/share/voice-input-sherpa-onnx/lexicons/user_corrections.rules"),
        help="Rules file path",
    )
    p.add_argument(
        "--history",
        default=os.path.expanduser("~/.local/state/voice-input-sherpa-onnx/history.jsonl"),
